...
popDynLMLMuR1 <- read.csv("../results/Inversion/20200302withInvLowMigLowMut/1751568804886_outputPopDynam.csv")
popDynLMLMuR2 <- read.csv("../results/Inversion/20200302withInvLowMigLowMut/1751570485992_outputPopDynam.csv")
invQTNsLMLMuR1 <- read.csv("../results/Inversion/20200302withInvLowMigLowMut/1751568804886_outputInvTime.csv")
invQTNsLMLMuR2 <- read.csv("../results/Inversion/20200302withInvLowMigLowMut/1751570485992_outputInvTime.csv")

# Low Migration Low Mutation -No Inversions
popDynNoInLMLMuR1 <- read.csv("../results/Inversion/20200302withoutInvLowMigLowMut/1751566183207_outputPopDynam.csv")
popDynNoInLMLMuR2 <- read.csv("../results/Inversion/20200302withoutInvLowMigLowMut/1751626452845_outputPopDynam.csv")
...
popDynMMLMuR1 <- read.csv("../results/Inversion/20200303withInvMedMigLowMut/2065972841416_outputPopDynam.csv")
invQTNsMMLMuR1 <- read.csv("../results/Inversion/20200303withInvMedMigLowMut/2065972841416_outputInvTime.csv")
#invQTNsMMLMuR2 <- read.csv("../results/Inversion/20200302withInvMedMigLowMut/1751582301417_outputInvTime.csv")

# No Inversions
popDynNoInMMLMuR1 <- read.csv("../results/Inversion/20200303withoutInvMedMigLowMut/1751629716441_outputPopDynam.csv")
popDynNoInMMLMuR2 <- read.csv("../results/Inversion/20200303withoutInvMedMigLowMut/1751630159938_outputPopDynam.csv")


#### High migration low mutation ####
##  Inversions
popDynHMLMuR1 <- read.csv("../results/Inversion/20200302withInvHighMigLowMut/1751625359138_outputPopDynam.csv")
popDynHMLMuR2 <- read.csv("../results/Inversion/20200302withInvHighMigLowMut/1751583067058_outputPopDynam.csv")
invQTNsHMLMuR1 <- read.csv("../results/Inversion/20200302withInvHighMigLowMut/1751625359138_outputInvTime.csv")
invQTNsHMLMuR2 <- read.csv("../results/Inversion/20200302withInvHighMigLowMut/1751583067058_outputInvTime.csv")

# No Inversions
popDynNoInHMLMuR1 <- read.csv("../results/Inversion/20200303withoutInvHighMigLowMut/1751628536499_outputPopDynam.csv")
popDynNoInHMLMuR2 <- read.csv("../results/Inversion/20200303withoutInvHighMigLowMut/1751629252645_outputPopDynam.csv")

#### High migration high mutation ####
##  Inversions
popDynHMHMuR1 <- read.csv("../results/Inversion/20200302withInvHighMigHighMut/1751583946190_outputPopDynam.csv")
invQTNsHMHMuR1 <- read.csv("../results/Inversion/20200302withInvHighMigHighMut/1751583946190_outputInvTime.csv")

# No Inversions
popDynNoInHMHMuR1 <- read.csv("../results/Inversion/20200303withoutInvHighMigHighMu/1751616892960_outputPopDynam.csv")
popDynNoInHMHMuR2 <- read.csv("../results/Inversion/20200303withoutInvHighMigHighMu/1751620201657_outputPopDynam.csv")
...
par(mfrow = c(1,2))
# Local Adaptation
plot(as.numeric(as.character(popDynLMLMuR1$localAdaptSA))~popDynLMLMuR1$sim_gen, type = "l", data = popDynLMLMuR1, ylab = "Local Adaptation", xlab = "Generation", ylim = c(0,1), main = "With Inversions")
lines(as.numeric(as.character(popDynMMLMuR1$localAdaptSA))~popDynMMLMuR1$sim_gen, type = "l", col = "blue", data = popDynMMLMuR1)
lines(as.numeric(as.character(popDynHMLMuR1$localAdaptSA))~popDynHMLMuR1$sim_gen, type = "l", col = "red", data = popDynHMLMuR1)
legend("topleft", legend = c("0.001", "0.01", "0.5"), lty = 1, col = c("black", "blue", "red"), cex = 0.7, title = "Migration")
## no inversions
