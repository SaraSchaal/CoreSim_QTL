...
write.table(df.params.rerun2, "src/rerun2_invSimParams.txt", row.names = FALSE)

rerun3 <- c("3385076", "3385052", "3385061", "3385037", "3385079", "3385070", "3385073", "3385058", "3385064", "3385043",
            "3385055", "3385022", "3385046", "3385031", "3385049", "3385016", "3385067", "3385019", "3385028", "3385034",
            "3385040", "3385010", "3385007", "3385013", "3385004", "3384998", "3384989", "3384986", "3385001", "3384995",
            "3384992", "3384977", "3384968", "3384959", "3384956", "3384953", "3384950", "3384947", "3384935", "3384920",
            "3384896", "3384902", "3384890", "3384899", "3384926", "3384929", "3384923", "3384884", "3384911", "3384893",
            "3384908", "3384887", "3384881", "3384836", "3384839", "3384824", "3384833", "3384842", "3384830", "3384815",
            "3384827", "3384812", "3384818", "3384821", "3384800", "3384803", "3384791", "3384797", "3384794", "3384806",
            "3384809")

df.params.rerun3 <- df.params[df.params$seed %in% rerun3, ]

write.table(df.params.rerun3, "src/rerun3_invSimParams.txt", row.names = FALSE)

df.params[df.params$mig1 == 0.1 & df.params$muBase ==  0.000001 
            & df.params$sigmaK == .75 & df.params$alpha == 0.002 
            & df.params$enVar == 0 & df.params$muInv == 0, ]

#3384602 poly low low mig weak select - no island
#3384603 poly low mig weak select - no island
#3384604 poly mod mig weak select - no island
#3384605 poly high mig weak select - no island
#3384606 poly high high mig weak select - no island

#3384482 poly low low mig mod select - no island
#3384483 poly low mig mod select - island
#3384484 poly mod mig mod select - no island
#3384485 poly high mig mod select - no island
#3384486 poly high high mig mod select - no island

#3384362 poly low low mig strong select - no islands just high fst across all
#3384363 poly low mig strong select - no islands just high fsts
#3384364 poly mod mig strong select - islands
#3384365 poly high mig strong select - no islands
#3384366 poly high high mig strong select - no islands


df.params.2[df.params.2$mig1 == 0.25 & df.params.2$muBase ==  0.00000001 
            & df.params.2$sigmaK == 0.75 & df.params.2$alpha == 0.2 
            & df.params.2$enVar == 0 & df.params.2$muInv == 0.001, ]
