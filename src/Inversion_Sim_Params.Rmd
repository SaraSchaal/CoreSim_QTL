...
df.params[df.params$mig1 == 0.001 & df.params$muBase ==  0.000001 
...
3384962
#3383402 oligo low low mig mod select - inv 3383822
#3383403 oligo low mig mod select - inv 3383823
#3383404 oligo mod mig mod select - inv 3383824
#3383405 oligo high mig mod select - inv 3383825
#3383406 oligo high high mig mod select - inv 3383826
...
#3383285 oligo high mig strong select - inv 3383705
#3383286 oligo high high mig strong select - inv 33836706


df.params.2[df.params.2$mig1 == 0.25 & df.params.2$muBase ==  0.00000001 
            & df.params.2$sigmaK == 0.75 & df.params.2$alpha == 0.2 
            & df.params.2$enVar == 0.001 & df.params.2$muInv == 0.001, ]
