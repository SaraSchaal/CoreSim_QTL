...
#levels polygenicity
  ...
  5*  # selection strength omega.sq, sample runif from 0.9, 1.5, 5, 25, (visualize first with simulation then decide to keep in or not 50)
...
mc_mult <- c(0.1, 0.5, 0.9, 1, 1.1, 1.5, 2)
...
MU_inv = c( 1,  0) #orders of magnitude higher or lower than mu_base
sigma_k <- c(0.9, 1.5, 5, 25, 50)
alpha_sd <- c(0.002, 0.2) #sd of effect sizes of QTN mutations
