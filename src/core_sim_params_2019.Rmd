...
length(ntot)* #levels polygenicity
  ...
  1* #levels Ne, 1000
  2* #levels envi var,  
  5* #levels migration, 0.5, 0.9, 1.5, 1, 1.1, 2
  4* #levels, sample runif from Ne*mu=0.0001, 0.001, 0.01, 0.1
  2* # levels recombination
  #2 # standing variation vs. new mutation
  5*  # selection strength omega.sq, sample runif from 0.9, 1.5, 5, 25, 50
  5 # replicates per level

tot
(tot*300) # total number of minutes
min_serv = (tot*300)/70 # total number of minutes per server (60 servers)
