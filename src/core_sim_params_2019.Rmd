...
#levels polygenicity
  1* #levels Ne, 1000
  3* #levels envi var,  0,1, visualize normal distributions of the envir variance on the phenotypes compared to the optima (play with some values)
  ...
  5* # mu_QTN_prop log scale 0, 0.0001, 0.001, 0.01, 0.1
  2* # alpha (preliminary set for determining best levels of alpha); (visualize) 0.007, 0.7 
